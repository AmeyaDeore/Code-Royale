...
const Weather = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-textPrimary">Health-Focused Weather</h1>
        <p className="text-textSecondary">7-day forecast with AI environmental health alerts.</p>
      </div>

      {highAqiDay && (
        <InsightCard
          type="warning"
          message={`Alert: Air Quality Index (AQI) is expected to reach ${highAqiDay.aqi} on ${format(new Date(highAqiDay.date), 'EEEE')}. Patients with respiratory issues (like Asthma) should stay indoors and limit physical exertion.`}
        />
      )}
